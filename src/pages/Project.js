export default function Project() {
    return(
        <main>
          ...
          <section className="flex flex-col items-center gap-16 sm:flex-row sm:justify-around px-2 lg:mx-96">
          ...
          {/*spécificité*/}
          <section className="py-14 gap-8 flex flex-col items-center">
            <h2 className="text-center">
              DÉTAILS TECHNIQUES
            </h2>

            <table className="border-separate border-spacing-y-2 lg:w-1/3">
              <tr>
          ...
          {/*FAQ*/}
          <section className="py-14 flex flex-col gap-8 p-2 lg:mx-96">
            <h2>FAQ</h2>
